...
class Driver:
    ...
    def run(self):
        ...
        print("#####################################################")
        results = fh_01.exercise_01_write_user_name_to_file()
        results = fh_01.exercise_02_read_and_print_file()
        results = fh_01.exercise_03_read_file_line_by_line()
        results = fh_01.exercise_04_read_file_into_list()
        results = fh_01.exercise_05_append_data_to_file()
        results = fh_01.exercise_06_clear_file_content()
        results = fh_01.exercise_07_write_text_to_new_file()
        results = fh_01.exercise_08_check_if_file_exists()
        results = fh_01.exercise_09_handle_missing_file()
        results = fh_01.exercise_10_count_lines_in_file()
