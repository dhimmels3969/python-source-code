...
def build_file_name2(src_dir, file_name):
    """
...
def exercise_06_write_file(root_dir):
    """
    ...
    :rtype:
    """
    print("Exercise 6: Write all content of a file into a new file ")
    ...
    file_path = hf.build_file_name(root_dir, "data", "test_out_v2.txt")
...
def exercise_05_multiple_input_test():
    ...
    """
    print("Exercise 5: Accept any three string from one input() call")
...
def exercise_12_format_string():
    ...
    """
    print("Exercise 12: Format variables using string.format() method")
    totalMoney = 1000
    quantity = 3
    price = 450
    n_t_t = 16384
...
def exercises_03_04_display_hex_and_octal():
    ...
    :rtype:
    """
    print("Exercise 3. Convert decimal number to octal")
    print("Exercise 4. Binary representation")
...
def ex_06_hexadecimal_representation():
    ...
    """
    print("\nExercise 6: Display integer as hexadecimal")
...
def exercise_10_center_aligned_text():
    ...
    print("Exercise 10. Center-aligned text")
    DEFAULT_LENGTH = 40
    OVERFLOW_LENGTH = 10
