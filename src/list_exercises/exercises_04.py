...
def exercise_31_filter_by_value_length():
    ...
    """
    logger.info("Exercise 31. Filter Strings by Length in a List")
...
def exercise_32_sorted_list_check():
    ...
    logger.info("Exercise 32. Check if List is Sorted")
    input_list = [10, 20, 30, 25, 40]
    results = is_list_sorted(input_list)
    logger.info(f"  List: {input_list} Sorted: {results}")
...
def exercise_33_list_to_dictionary_conversion():
    ...
    """
    logger.info("Exercise 33. List to Dictionary Conversion")
    keys = ["name", "age", "city"]
    values = ["Alice", 25, "New York"]
    results_dictionary = {}
    ...
    logger.info(f"  Dictionary: {results_dictionary}")
    pass
...
def exercise_34_list_differences():
    ...
    """
    logger.info("Exercise 34. Find the Difference Between Two Lists")
    list_a = [1, 2, 3, 4, 5]
    list_b = [2, 4, 6]
    results = list(set(list_a) - set(list_b))
    logger.info(f"  Difference (A – B): {results}")
    pass
...
def exercise_35_remove_values_in_place():
    ...
    """
    logger.info("Exercise 35. Remove Negative Numbers In-place")
...
def exercise_36_extend_nested_list():
    ...
    """
    logger.info("Exercise 36. Extend Nested List by Adding a Sublist")
...
def exercise_37_concatenate_lists():
    ...
    """
    logger.info("Exercise 37. Concatenate Lists")
    list_1 = ["Hello ", "Take "]
    list_2 = ["Dear", "Sir"]
...
def exercise_38_flatten_nested_list():
    ...
    """
    logger.info("Exercise 38. Flatten Nested List (2D to 1D)")
    input_list = [[1, 2, 3], [4, 5, 6, 7, 8, 9]]
    flattened_list = [item for sublist in input_list for item in sublist]
    logger.info(f"  1D List: {flattened_list}")
    pass
...
def exercise_39_flatten_deeply_nested_lists():
    ...
    logger.info("Exercise 39. Flatten Deeply Nested List (Recursion)")
    # input_list = [1, [2, 3, 4]]
    ...
    logger.info(f"  Flattened: {final_results}")
    pass
...
def exercise_40_calculate_cumulative_sum():
    ...
    """
    logger.info("Exercise 40. Calculate Cumulative Sum (Prefix Sums)")
    ...
    logger.info(f"  Cumulative Sum: {totals_list}")
    pass
